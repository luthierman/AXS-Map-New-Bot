...
// functions
    ...
    if (await page.evaluate(() => document.querySelector('#email')) !== null) {  
        ...
        await page.waitFor(100)
        // if block for button at login
        // if (await page.evaluate(() => document.querySelector('#root > div > div.sc-eTuwsz.fkObQb.sc-cHGsZl.jHpOIv > div.is-full.sc-jzJRlG.eKLUhM > div.bg-gray-300.sc-fjdhpX.gDdLtD > div > div > div.sc-cIShpX.dOgYkc > div > div > div > div.carousel.carousel--lg > div > div > ul > div > div > li > div > div.sc-btzYZH.etdARI > div.is-full.sc-jzJRlG.eKLUhM > div:nth-child(1) > button')== null)){
        //     await page.click('#root > div > div.sc-hZSUBg.crcKnG.sc-uJMKN.dgFTbm > div.is-full.sc-cSHVUG.xcqje > div.bg-gray-300.sc-jzJRlG.dHyNGc > div > div > div.sc-btzYZH.bHWYk > div > div > div > div.carousel.carousel--lg > div > div > ul > li.slide___3-Nqo.slideHorizontal___1NzNV.carousel__slide.carousel__slide--visible > div > div.sc-dqBHgY.jqMQJe > div.is-full.sc-cSHVUG.xcqje > div:nth-child(1) > button')  
        //     await page.waitFor(100)
        // }
